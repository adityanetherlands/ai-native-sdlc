// Supabase Edge Function: "ask-org"
//
// Sibling of `ask` — grounded Q&A for the /ai-org page ("The New Operating
// Model Is The Moat"). Proxies multi-turn questions to Anthropic's Messages
// API with a strict grounding prompt. The model is only permitted to answer
// from the baked page corpus; any question not covered gets a fixed refusal.
//
// Env:
...
function buildSystemPrompt(chunks: ChunkRow[]): string {
  ...
  return [
    `You answer questions about a specific webpage titled "The New Operating Model Is The Moat" — an essay on AI-native organisational design for R&D leaders.`,
