...
A spec-driven, agent-powered operating model where AI agents own structured execution across every phase - humans govern direction, quality, and risk. Not a copilot bolted onto waterfall. A fundamentally different way to build software.
...
### Phase 01: Ideation & Problem Discovery

**Tagline:** From raw signal to validated problem space

**Agents:** discovery-agent, market-radar
...
**Why This Phase Matters:** Without continuous signal ingestion, product teams react to the loudest voice instead of the most urgent need. This phase ensures every feature request is validated against real market data, customer pain, and competitive landscape. It replaces gut-feel backlog management with data-driven prioritisation.
...
Tools: Claude API, Web Search, Notion MCP, Slack MCP
...
Tools: Web Fetch, RSS Ingest, Crunchbase API
...
Tools: Claude Sonnet, Mermaid Charts, FigJam API
...
### Phase 02: Product Requirements (PRD)

**Tagline:** Structured, buildable product definition

**Agents:** prd-architect, ux-researcher
...
The PRD covers: user personas, jobs-to-be-done, functional requirements, non-functional requirements (performance, security, accessibility), data models, API contracts, notification design, edge cases, success metrics, and rollout strategy.
...
**Why This Phase Matters:** A vague PRD creates a game of telephone between product and engineering. When an AI agent generates the PRD with full technical context - data models, API contracts, edge cases - the ambiguity gap disappears.

#### Example Agents & Skills

**PRD Architect** `prd-architect-pro`
Generates full PRDs from problem briefs. Covers modules, APIs, data models, security model, notification design, error handling, metrics, and phased rollout plan. References existing product specs for consistency.
Tools: Claude Opus, GitHub MCP, Notion MCP, Linear MCP

**UX Research Agent** `ux-insight`
Generates user journey maps, identifies UX friction points, benchmarks competitor flows, and produces wireframe suggestions with accessibility annotations (WCAG AA).
Tools: Figma API, Hotjar Data, Web Fetch
...
Tools: GitHub MCP, Mermaid Charts, AST Parser
...
**Tagline:** The binding contract that agents code against

**Agents:** spec-writer, contract-validator
...
In a **living product**, specs are versioned and diff-aware. When a feature evolves, the Spec Agent generates a spec delta - showing exactly what changed, what's backwards-compatible, and what requires migration. The spec becomes the **living contract** between product intent and code reality.

**Spec-driven development means:** no code gets written until the spec passes validation. No test gets generated without referencing the spec. No demo gets built that doesn't trace back to spec assertions. Drift between code and spec triggers automated alerts.

**Why This Phase Matters:** This is the keystone of the entire model. Every downstream agent - coder, tester, reviewer, documenter - traces back to the spec. If the spec is precise, the entire pipeline accelerates. If it's vague, every phase pays the tax.
...
Tools: Claude Opus, OpenAPI Generator, JSON Schema, GitHub MCP
...
Tools: Schema Validator, Traceability Matrix, Claude Sonnet
...
Tools: Git Diff, Semantic Versioning, Migration Generator
...
### Phase 04: Architecture & System Design

**Tagline:** Infrastructure decisions that scale

**Agents:** arch-planner, infra-scout
...
**Why This Phase Matters:** Architecture mistakes are the most expensive bugs. An AI agent that reads existing infrastructure, evaluates trade-offs against real benchmarks, and generates ADRs with rationale creates architecture decisions that are defensible, not just instinctive.
...
Tools: Claude Opus, Mermaid Charts, Terraform Templates, AWS/GCP APIs
...
Tools: Cloud Pricing APIs, Benchmark Suite, Supabase MCP
...
**Tagline:** AI agents write production code from spec

**Agents:** code-engine, ui-ux-pro-max, api-builder
...
**Why This Phase Matters:** Code generation isn't the hard part - generating code that respects existing patterns, passes existing tests, and integrates with existing services is. This phase treats implementation as spec-execution, not creative writing.
...
Tools: Claude Code, GitHub MCP, AST Analysis, ESLint/Prettier
...
Tools: Claude Code, Figma API, Storybook, Axe Accessibility
...
Tools: OpenAPI Codegen, Postman MCP, Claude Code
...
Tools: Supabase MCP, Prisma/Drizzle, Migration Validator
...
### Phase 06: Code Review & Quality

**Tagline:** Multi-agent review against spec and standards

**Agents:** review-sentinel, spec-drift-detector
...
**Why This Phase Matters:** Human code review is a bottleneck that doesn't scale. AI review agents can catch 90% of issues instantly - pattern violations, security antipatterns, performance regressions - leaving humans to focus on design judgment calls.
...
Tools: Claude Opus, GitHub MCP, SonarQube, ESLint
...
Tools: Spec Parser, AST Diff, Contract Testing
...
**Tagline:** Spec-derived test suites, generated and executed

**Agents:** test-forge, chaos-monkey, perf-bench
...
**Why This Phase Matters:** Testing is the phase where spec-driven development pays its biggest dividend. When tests are generated directly from machine-readable acceptance criteria, coverage isn't a metric to chase - it's a natural byproduct.
...
Tools: Claude Code, Jest/Vitest, Playwright, Postman MCP
...
Tools: Fuzzing Engine, Load Generator, Claude Sonnet
...
Tools: k6/Artillery, Lighthouse, Chrome DevTools Protocol
...
**Tagline:** Threat modelling and vulnerability scanning, automated

**Agents:** sec-guardian, compliance-check
...
**Why This Phase Matters:** Security can't be a phase-gate bolt-on. When a security agent scans every commit, validates every dependency, and checks every API against OWASP in real-time, security shifts from audit to continuous assurance.
...
Tools: Semgrep, Snyk API, OWASP ZAP, Claude Opus
...
Tools: Policy Engine, Audit Logger, Data Flow Mapper
...
### Phase 09: Demo & Staging

**Tagline:** Auto-generated demos and stakeholder previews

**Agents:** demo-builder, staging-deploy
...
**Why This Phase Matters:** The gap between 'it works on my machine' and 'stakeholders can see it' is where momentum dies. Automated staging with synthetic data and shareable preview links turns every merge into a demoable milestone.
...
Tools: Playwright, Seed Data Gen, Screen Recorder, Vercel MCP
...
Tools: Vercel MCP, Docker, Supabase MCP, GitHub Actions
...
**Tagline:** Living docs generated from code, spec, and usage

**Agents:** doc-weaver, api-doc-gen
...
**Why This Phase Matters:** Documentation written after the fact is always wrong. When a documentation agent generates docs from the spec and code simultaneously, docs become a living artefact - not a post-launch chore that nobody wants to do.
...
Tools: Claude Sonnet, GitHub MCP, Notion MCP, MDX Generator
...
Tools: OpenAPI Parser, Postman MCP, Code Example Gen
...
**Tagline:** Automated release notes, changelogs, and deployment

**Agents:** release-captain, changelog-gen
...
**Why This Phase Matters:** Release engineering is toil. When an AI agent handles changelog generation, version bumping, deployment orchestration, and rollback triggers, releases become a non-event - which is exactly what they should be.
...
Tools: GitHub Actions, Vercel MCP, LaunchDarkly, Datadog
...
Tools: Claude Sonnet, Git Log Parser, Notion MCP, Slack MCP
...
**Tagline:** Closes the loop - production signals feed Phase 01

**Agents:** prod-watcher, feedback-loop
...
Monitors production health: error rates, latency, resource usage, user behaviour anomalies. Classifies issues and routes to appropriate lifecycle phase. Triggers auto-remediation for known patterns.
Tools: Datadog/Grafana, PagerDuty, Sentry, Claude Sonnet
...
Tools: Analytics Pipeline, NPS/CSAT Tools, Linear MCP, Notion MCP
...
### // 02 Feature Branches as Contexts
...
### // 03 Regression-Aware Generation
...
### // 04 Continuous Spec-Code Reconciliation
...
### // 06 Deprecation & Sunset Automation
...
The shift isn't about adding AI to existing processes. It's about redesigning the process around AI-native capabilities. Here's what changes - and how familiar phases map to this new model.

### Traditional SDLC vs AI-Native SDLC

**Traditional SDLC:** Requirements are written for people to interpret. Teams manually coordinate handoffs between phases. Testing follows implementation and often lags it.

**AI-Native SDLC:** Specs are structured for both humans and machines to execute against. Agents execute bounded handoffs with traceable outputs. Tests are derived from spec intent before implementation begins.

**Traditional SDLC:** Code review checks style and obvious bugs. Documentation is an afterthought that lags shipped code. Release is an endpoint followed by maintenance.

**AI-Native SDLC:** Review validates semantic correctness, spec alignment, and architectural fit. Docs are continuously regenerated from spec and code artifacts. Release is one state in a continuous, feedback-driven evolution loop.

### Mapping to Traditional Phases

For teams transitioning from conventional processes.

| Traditional Phase | AI-Native Equivalent | What's Different |
|---|---|---|
| Requirements Gathering | Phase 1 (Ideation) + Phase 2 (PRD) | Signal-driven, evidence-backed, machine-usable |
| Design & Architecture | Phase 3 (Spec) + Phase 4 (Architecture) | Spec is an executable contract, not a document |
| Development | Phase 5 (Implementation) | Agent-generated, spec-conformant, context-aware |
| QA & Testing | Phase 6 (Review) + Phase 7 (Testing) | Spec-derived, adversarial, continuous |
| Security Review | Phase 8 (Security) | Threat modelling + compliance as automated continuous process |
| UAT & Staging | Phase 9 (Demo & Staging) | Auto-generated demos, ephemeral environments per feature |
| Technical Writing | Phase 10 (Documentation) | Living docs regenerated from code and spec |
| Deployment | Phase 11 (Release) | Feature flags, canary, auto-rollback |
| Maintenance & Support | Phase 12 (Monitoring & Evolution) | Closes the loop - production feeds ideation |

---

## What This Blueprint Is and Is Not

**What It Is:** A north star model for AI-native software delivery. A conceptual blueprint for product and engineering alignment. A way to think about specs, agents, humans, and feedback as one coordinated system. Provocative by design - intended to challenge assumptions about how software gets built.

**What It Is Not:** Not a locked implementation architecture - adapt it to your stack and maturity. Not a mandate for zero-human development - humans govern, agents execute. Not a claim that every phase must be fully automated from day one. Not a replacement for product judgment or engineering leadership.

---

A Spec-Driven, Agent-Powered Operating Model | Adi Kumar
